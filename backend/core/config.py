...
class Config:
    ...
    MIN_COUNTRY_VISIT_DURATION_FOR_STATS = os.getenv("MIN_COUNTRY_VISIT_DURATION_FOR_STATS", 60 * 5)
    MIN_CITY_VISIT_DURATION_FOR_STATS = os.getenv("MIN_CITY_VISIT_DURATION_FOR_STATS", 60 * 60)
